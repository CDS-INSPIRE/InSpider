...
public class ProductionFacilityValidatorTest {

	private ProductionFacilityValidator validator;
	private ValidationRunner<ProductionFacility, Message, Context> runner;
	private GeometryConstants geom;

	@Before
	public void createValidator() throws Exception {
		validator = new ProductionFacilityValidator(Collections.emptyMap());
		runner = new ValidationRunner<>(validator, ProductionFacility.class);
		geom = new GeometryConstants("EPSG:28992");
	}

	private ValidationRunner<ProductionFacility, Message, Context>.Runner run(final String validationName) {
	...
	public void getThematicIdentifierValidator () throws Throwable {
		...
		ProductionFacility feature = new ProductionFacility();
...
//		    .assertOnlyKey (ATTRIBUTE_CODE_INVALID);
	...
	public void getStatusValidator () throws Throwable {
		...
		feature = new ProductionFacility();
		feature.setStatusDescription("a");
