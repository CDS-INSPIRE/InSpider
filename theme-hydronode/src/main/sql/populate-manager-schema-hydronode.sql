...
insert into manager.datasettype (id, naam, thema_id) values ((select nextval('manager.hibernate_sequence')), 'HydroNetworkNodesNL', (select id from manager.thema t where t.naam = 'HydroNode'));
