...
@Table(name = "exposed_elements", schema = "bron")
public class ExposedElements extends PersistableFeature {
	...
	@MappableAttribute
	@CodeSpace("http://www.inspire-provincies.nl/codeList/DatasetTypeCode/ExposedElements")
