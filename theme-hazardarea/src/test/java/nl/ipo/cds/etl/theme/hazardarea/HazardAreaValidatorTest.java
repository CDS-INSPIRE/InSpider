...
public class HazardAreaValidatorTest {

	private HazardAreaValidator validator;
	private ValidationRunner<HazardArea, Message, Context> runner;
	private GeometryConstants geom;

	@Before
	public void createValidator() throws Exception {
		validator = new HazardAreaValidator(Collections.emptyMap());
		runner = new ValidationRunner<>(validator, HazardArea.class);
		geom = new GeometryConstants("EPSG:28992");
	}

	private ValidationRunner<HazardArea, Message, Context>.Runner run(final String validationName) {
